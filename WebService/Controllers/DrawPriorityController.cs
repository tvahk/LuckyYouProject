...
namespace WebApi.Controllers
{
    ...
    /// </summary>
    public class DrawPriorityController : ApiController
    {
        private readonly IUOW _uow;
        private BLL.Service.DrawPriorityService _service;

        public DrawPriorityController(IUOW uow)
        {
            _uow = uow;
            _service = new BLL.Service.DrawPriorityService();
        }
        ...
        /// </summary>
        /// <returns></returns>
        public List<DrawPriorityDTO> GetDrawPririties()
        {
            return _service.getAllDrawPriorities();
        }
        ...
        /// <returns></returns>
        [ResponseType(typeof(DrawPriority))]
        public IHttpActionResult GetDrawPriority(int id)
        {
            var draw = _service.getDrawPrioritylById(id);
            if (draw == null)
            {
                return NotFound();
            }
