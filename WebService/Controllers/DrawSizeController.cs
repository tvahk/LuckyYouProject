...
namespace WebApi.Controllers
{
    ...
    /// </summary>
    public class DrawSizeController : ApiController
    {
        private readonly IUOW _uow;
        private BLL.Service.DrawSizeService _service;

        public DrawSizeController(IUOW uow)
        {
            _uow = uow;
            _service = new BLL.Service.DrawSizeService();
        }
        ...
        /// </summary>
        /// <returns></returns>
        public List<DrawSizeDTO> GetDrawSizes()
        {
            return _service.getAllDrawSizes();
        }
        ...
        /// <returns></returns>
        [ResponseType(typeof(DrawSize))]
        public IHttpActionResult GetDrawSize(int id)
        {
            var draw = _service.getDrawSizeById(id);
            if (draw == null)
            {
                return NotFound();
            }
